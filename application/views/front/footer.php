        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <ul class="unstyled address">
                    <li>
                        <i class="icon-home"></i><strong>Alamat:</strong> Leces, Kabupaten Probolinggo<br>NY 11793
                    </li>
                    <li>
                        <i class="icon-envelope"></i>
                        <strong>Email: </strong> denispuspita321@email.com
                    </li>
                    <li>
                        <i class="icon-globe"></i>
                        <strong>Website:</strong> www.amiktaruna2023.com
                    </li>
                    <li>
                        <i class="icon-phone"></i>
                        <strong>contact free:</strong> 081231914079
                    </li>
                </ul>
            </div>
            <!--End Contact Form-->
